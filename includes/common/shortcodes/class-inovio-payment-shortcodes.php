...
// Load hooks into constructor
    ...
    public function inovio_admin_setting_form( $form_type = "" ) {
        ...
        $form = array(
            ...
            'accept_visa' => array (
                'title'       => Zigu_Translator::t( 'Aceptar Visa' ),
                'type'        => 'checkbox',
                'label'       => Zigu_Translator::t( 'Aceptar Visa' ),
                'description' => Zigu_Translator::t( 'Permite pagar con tarjetas Visa en el checkout.' ),
                'desc_tip'    => true,
                'default'     => 'yes',
            ),
            'accept_mastercard' => array (
                'title'       => Zigu_Translator::t( 'Aceptar MasterCard' ),
                'type'        => 'checkbox',
                'label'       => Zigu_Translator::t( 'Aceptar MasterCard' ),
                'description' => Zigu_Translator::t( 'Permite pagar con tarjetas MasterCard en el checkout.' ),
                'desc_tip'    => true,
                'default'     => 'yes',
            ),
            'accept_amex' => array (
                'title'       => Zigu_Translator::t( 'Aceptar American Express' ),
                'type'        => 'checkbox',
                'label'       => Zigu_Translator::t( 'Aceptar American Express' ),
                'description' => Zigu_Translator::t( 'Permite pagar con tarjetas American Express en el checkout.' ),
                'desc_tip'    => true,
                'default'     => 'no',
            ),
            'debug' => array (
